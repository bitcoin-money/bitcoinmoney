...
[Bitcoin git repository](https://github.com/bitcoin-money/bitcoin) but are not part of
...
idea to build Bitcoin Money against a static version of that library compiled
