...
def main():
    ...
    enable_bitcoind = config["components"].getboolean("ENABLE_BITCOINMONEYD")

    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/bitcoin-money/bitcoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/bitcoin-money/bitcoin/pull/5677#issuecomment-136646964
...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=[], combined_logs_len=0):
    ...
    #Set env vars
    if "BITCOINMONEYD" not in os.environ:
        os.environ["BITCOINMONEYD"] = build_dir + '/src/bitcoind' + exeext
        os.environ["BITCOINMONEYCLI"] = build_dir + '/src/bitcoin-cli' + exeext
