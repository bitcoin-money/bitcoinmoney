Bitcoin Money version 0.13.1 is now available from:
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  ...
  note that Bitcoin Money does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bitcoin users to individually opt-in to almost any change in the Bitcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Bitcoin Money contributors that may use this
...
Since Bitcoin Money 0.10.0, nodes have defaulted to only relaying and
