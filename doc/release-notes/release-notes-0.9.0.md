Bitcoin Money version 0.9.0 is now available from:
...
Rebranding to Bitcoin Money
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to Bitcoin Money.
...
0.1mBCMY per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mBCMY per kilobyte
