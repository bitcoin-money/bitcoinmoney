Bitcoin Money version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of Bitcoin Money
randomly crashing on Windows XP. It is [not clear](https://github.com/bitcoin-money/bitcoin/issues/7681#issuecomment-217439891)
...
Various code modernizations have been done. The Bitcoin Money code base has
...
HD wallets are incompatible with older versions of Bitcoin Money.

[Pull request](https://github.com/bitcoin-money/bitcoin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
proposed parameters, a future release of Bitcoin Money is expected that
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/bitcoin-money/bitcoin/pull/7762).
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use BCMY/kB (MarcoFalke)
