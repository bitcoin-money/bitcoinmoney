Bitcoin Money version 0.14.0 is now available from:
...
Bitcoin Money is extensively tested on multiple operating systems using
...
Bitcoin Money should also work on most other Unix-like systems but is not
...
Bitcoin Money has supported automatically pruning the blockchain since 0.11. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/bitcoin-money/bitcoin/blob/master/doc/zmq.md) for
...
When Bitcoin Money is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Bitcoin Money 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Bitcoin Money. This was added in conjunction with
   optimizations to memory management. See [Pull #8753](https://github.com/bitcoin-money/bitcoin/pull/8753)
