...
const QString BITCOIN_IPC_PREFIX("bitcoinmoney:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bitcoinmoney-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitcoinmoney-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitcoinmoney-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start bitcoinmoney: click-to-pay handler"));
        }
        else {
...
bool PaymentServer::processPaymentRequest(const PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    for (const std::pair<CScript, CAmount>& sendingTo : sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Unauthenticated payment requests to custom bitcoinmoney addresses are not supported
        ...
        // Bitcoin Money amounts are stored as (optional) uint64 in the protobuf messages (see paymentrequest.proto),
